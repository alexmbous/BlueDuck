...
import com.blueduck.ride.refresh.internal.EmptyViewMethodAccessor;
import com.blueduck.ride.refresh.internal.IndicatorLayout;
import com.blueduck.ride.utils.LogUtils;


public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
        OnScrollListener{
    private static final String TAG = "PullToRefreshAdapterVie";
    ...
    public final void onScroll(final AbsListView view, final int firstVisibleItem, final int visibleItemCount,
        ...
        if (DEBUG) {
            LogUtils.d(TAG,"First Visible: " + firstVisibleItem + ". Visible Count: " + visibleItemCount
    ...
    private boolean isFirstItemVisible() {
        ...
        if (null == adapter || adapter.isEmpty()) {
            if (DEBUG) {
                LogUtils.d(TAG,"isFirstItemVisible. Empty View.");
            }
            return true;
    ...
    private boolean isLastItemVisible() {
        ...
        if (null == adapter || adapter.isEmpty()) {
            if (DEBUG) {
                LogUtils.d(TAG,"isLastItemVisible. Empty View.");
            }
            return true;
        } else {
            ...
            if (DEBUG) {
                LogUtils.d(TAG,"isLastItemVisible. Last Item Position: " + lastItemPosition + " Last Visible Pos: "
                        + lastVisiblePosition);
            }
