 ...
 *******************************************************************************/
package com.blueduck.ride.refresh;
...
import com.blueduck.ride.refresh.internal.FlipLoadingLayout;
import com.blueduck.ride.refresh.internal.LoadingLayout;
import com.blueduck.ride.refresh.internal.RotateLoadingLayout;
import com.blueduck.ride.refresh.internal.Utils;
import com.blueduck.ride.refresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    public void addView(View child, int index, ViewGroup.LayoutParams params) {
        if (DEBUG) {
            LogUtils.d(TAG,"addView: " + child.getClass().getSimpleName());
        }
    ...
    public final void setMode(Mode mode) {
        if (mode != mMode) {
            if (DEBUG) {
                LogUtils.d(TAG,"Setting mode to: " + mode);
            }
            mMode = mode;
            updateUIForMode();
        }
    ...
    final void setState(State state, final boolean... params) {
        mState = state;
        if (DEBUG) {
            LogUtils.d(TAG,"State: " + mState.name());
        }
    ...
    protected final void onSizeChanged(int w, int h, int oldw, int oldh) {
        if (DEBUG) {
            LogUtils.d(TAG,String.format("onSizeChanged. W: %d, H: %d", w, h));
        }
    ...
    protected final void refreshLoadingViewsSize() {
        ...
        if (DEBUG) {
            LogUtils.d(TAG,String.format("Setting Padding. L: %d, T: %d, R: %d, B: %d", pLeft, pTop, pRight, pBottom));
        }
    ...
    protected final void setHeaderScroll(int value) {
        if (DEBUG) {
            LogUtils.d(TAG,"setHeaderScroll: " + value);
        }
