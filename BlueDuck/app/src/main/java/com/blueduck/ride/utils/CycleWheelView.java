...
public class CycleWheelView extends ListView{
    ...
    private void init() {
        ...
        mItemLayoutId = R.layout.cycle_wheel_view_layout;
        mItemLabelTvId = R.id.cycle_wheel_text;
    ...
    /**
     * 设置滚轮的刻度列表
     * Set the scale list of the scroll wheel
     * @param labels
     */
    ...
    /**
     * 设置滚轮滚动监听
     * Set the wheel to scroll monitor
    ...
    /**
     * 获取滚轮的刻度列表
     * Get the scale list of the scroll wheel
     * @return
     */
    ...
    /**
     * 设置滚轮是否为循环滚动
     * Set whether the scroll wheel is circular scrolling
    ...
    /**
     * 获取当前滚轮位置的刻度
     * Get the scale of the current wheel position
     * @return
     */
     ...
     * If you need to customize the wheel for each Item, call this method to set the custom Item layout.
     * In the custom layout, you need a TextView to display the wheel scale.
     * @param itemResId 布局文件Id Layout file Id
     * @param labelTvId 刻度TextView的资源Id Scale TextView resource ID
     */
    ...
    /**
     * 设置选中刻度文字颜色
     * Set the selected scale text color
    ...
    /**
     * 设置滚轮刻度透明渐变值
     * Set the wheel scale transparent gradient value
     * @param alphaGradual
     */
     ...
     * Set the number of scales that the scroll wheel can display. It must be an odd number and greater than or equal to 3.
     * @param wheelSize
     * @throws CycleWheelViewException 滚轮数量错误 Wrong number of wheels
     */
    ...
    /**
     * 设置块的颜色 Set the color of the block
     * @param unselectedSolidColor 未选中的块的颜色 Unselected block color
     * @param selectedSolidColor 选中的块的颜色 The color of the selected block
     */
    ...
    /**
     * 设置分割线样式
     * Sets the splitter style
     * @param dividerColor 分割线颜色 Secant line color
     * @param dividerHeight 分割线高度(px) Height of dividing line (px)
     */
